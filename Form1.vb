Public Class Form1
    ...
    Private Sub connexion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles connexion.Click
        ...
        socket.Connect() 'permet la connexion au module via un socket
    ...
    Private Sub socket_DataArrival(ByVal sender As Object, ByVal e As Winsock_Orcas.WinsockDataArrivalEventArgs) Handles socket.DataArrival
        Dim reponse(20) As Byte 'création d'un tableau de 20 octets

        reponse = socket.Get 'insertion du contenu du socket dans le tableau
        valeur_entrees.Text = reponse(9) 'affichage des valeurs dans le TextBox

        If (clone.Checked = True) Then 'si le 
    ...
    Private Sub etat_socket_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles etat_socket.TextChanged
        ...
        If etat_socket.Text = "Connected" Then 'Si le socket est correctement connecté
            etat_socket.BackColor = Color.Green
            connexion.Enabled = False 'grise le bouton "Connexion"
            lecture.Enabled = True 'dégrise le bouton "Lire des entrées"
            deconnexion.Enabled = True 'dégrise le bouton "Déconnexion"
    ...
    Private Sub deconnexion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deconnexion.Click
        ...
        socket.Close() 'permet d'arrêter la connexion sans fermer l'application
    ...
    Private Sub ecriture_sorties_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ecriture_sorties.Click
        ...
        If (sortie_4.Checked) = True Then 'si la checkbox est cochée
            etat_sortie_1 = 1 'alors on met la variable "etat_sortie_1" à 1
        Else
            etat_sortie_1 = 0
        End If
        ...
        'variable contenant la valeur à écrire sur les sorties
        'Exemple : 
    ...
    Private Sub chenillard_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chenillard.Click
        ...
        For i As Byte = 0 To 15
            ...
            'tableau "dynamique" qui incrémente à chaque itération, la valeur des sorties
            socket.Send(chenillard) 'envoi du socket
            Sleep(1000) 'pause de 1000 ms (1 seconde) pour laisser le temps à notre oeil de voir l'avancement
        Next
